...
import com.dede.android_eggs.views.main.compose.EasterEggHighestItem
...
@Composable
fun PagerSettingsScreen(easterEggs: List<BaseEasterEgg> = EasterEggHelp.previewEasterEggs(),) {
