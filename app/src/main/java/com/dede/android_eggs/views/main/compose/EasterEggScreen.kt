...
import com.dede.android_eggs.routes.PagerSettingsScreen
import com.dede.android_eggs.routes.Scaffold
import com.dede.android_eggs.routes.globalRoutes
import com.dede.android_eggs.routes.searchResultRoute
import com.dede.android_eggs.routes.searchRoute
import com.dede.android_eggs.routes.settingsRoute
            ...
            Scaffold(
                ...
                saveableStateHolder.SaveableStateProvider(key = currentTabIndex) {
                    when (currentTabIndex) {
                        0 -> PagerSettingsScreen()

                        1 ->  PagerSettingsScreen()

                        2 ->  PagerSettingsScreen()
                        3 ->  PagerSettingsScreen()

                        4 ->  PagerSettingsScreen()
                    }
                }
            }
        }
